...
const TRACKS = {
  ...
  intermediate: {
    ...
    resources: [
      { id: 'i7', type: 'Reference', source: 'Official', title: 'Claude Code best practices', provider: 'Claude Code docs', desc: 'Working habits that transfer beyond coding: clear instructions, iteration, and letting Claude plan before it acts. Browse the docs menu for more, like how Claude Code works.', url: 'https://code.claude.com/docs/en/best-practices' },
      ...
      { id: 'i8', type: 'Course', source: 'Official', title: 'Interactive prompt engineering tutorial', provider: 'Anthropic', desc: 'Nine chapters of hands-on prompting exercises — the Google Sheets version needs no code at all.', url: 'https://github.com/anthropics/prompt-eng-interactive-tutorial' },
  ...
  developer: {
    ...
    resources: [
      ...
      { id: 'd14', type: 'Course', source: 'Official', title: 'Interactive prompt engineering tutorial', provider: 'Anthropic', desc: 'Nine chapters of exercises covering Claude prompting from basics through advanced techniques.', url: 'https://github.com/anthropics/prompt-eng-interactive-tutorial' },
      { id: 'd15', type: 'Course', source: 'Official', title: 'Claude Platform 101', provider: 'Anthropic Academy', desc: 'Build on the Claude Developer Platform from the ground up.', url: 'https://anthropic.skilljar.com/claude-platform-101' },
      ...
      { id: 'd16', type: 'Article', source: 'Official', title: 'Building effective agents', provider: 'Anthropic Engineering', desc: "Workflows vs agents, core design patterns, and when not to build an agent — Anthropic's canonical guide.", url: 'https://www.anthropic.com/research/building-effective-agents' },
      ...
      { id: 'd13', type: 'Reference', source: 'Official', title: 'Claude Code best practices', provider: 'Claude Code docs', desc: 'Patterns for getting the most out of Claude Code: setup, workflows, and agentic coding tips. The docs menu goes deeper — how Claude Code works, configuration, and more.', url: 'https://code.claude.com/docs/en/best-practices' },
      { id: 'd17', type: 'Reference', source: 'Official', title: 'Claude Cookbooks', provider: 'GitHub', desc: 'Official notebooks with working code: RAG, tool use, vision, embeddings, and more.', url: 'https://github.com/anthropics/claude-cookbooks' },
    ],
    quiz: [
