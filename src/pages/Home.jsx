...
const VISUALIZATIONS = [
  ...
  { path: '/ai-roi',               category: 'hands-on-practice',  tag: 'Executive AI',     title: 'AI ROI calculator',                  desc: 'Model the dollars-and-cents case for AI — token costs, hours saved, payback — and see what a naive ROI estimate leaves out.',  pills: ['ROI model', 'Token economics', 'Payback', 'Considerations'],                                ready: true },
