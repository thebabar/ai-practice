/* =====================================================================
   ...
   Consumed by src/pages/Glossary.jsx (the full reference page) and, from
   Phase 2 onward, by the auto-annotator that links these terms inline
   wherever they appear in page prose.

   Shape:
     id         stable numeric key (do not renumber — badges/links may
                reference it)
     term       display name, e.g. 'Large Language Model (LLM)'
     category   one of: Foundations | Tokens | Sampling | Agents |
                Embeddings | RAG
     definition prose definition
     example    optional illustrative example, or null
     seeIn      [{ label, path }] — internal pages covering the term
   ===================================================================== */
